...
#ifndef POLARGX_SWIFT_H
#define POLARGX_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="PolarGX",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
- (void)setAPNSWithDeviceToken:(NSData * _Nonnull)deviceToken;
- (void)setGCMWithFcmToken:(NSString * _Nonnull)fcmToken;
- (void)trackEventWithName:(NSString * _Nonnull)name attributes:(NSDictionary<NSString *, id> * _Nonnull)attributes;
...
SWIFT_CLASS("_TtC7PolarGX21PolarQuickIntegration")
@interface PolarQuickIntegration : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

SWIFT_CLASS("_TtC7PolarGX13PolarSettings")
@interface PolarSettings : NSObject
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) NSInteger pendingEventsCapacity;)
+ (NSInteger)pendingEventsCapacity SWIFT_WARN_UNUSED_RESULT;
+ (void)setPendingEventsCapacity:(NSInteger)value;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, copy) NSString * _Nullable appGroupIdentifier;)
+ (NSString * _Nullable)appGroupIdentifier SWIFT_WARN_UNUSED_RESULT;
+ (void)setAppGroupIdentifier:(NSString * _Nullable)value;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
